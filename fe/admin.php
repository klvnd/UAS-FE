                    ...
                    <form class="p-4 md:p-5">
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            ...
                            <div class="col-span-2">
                                ...
                                <input type="number" name="name" id="name" class="bg-white border border-blue-500 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 " placeholder="Harga Mobil Rp" required="">
                            </div>
                        </div>
