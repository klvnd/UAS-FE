...
<!-- penjelasan project -->
  <section class="bg-gray-900  shadow-xl">
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        ...
        <iframe class="mx-auto w-full lg:max-w-md rounded-lg sm:h-56 shadow-xl" src="https://www.youtube.com/embed/LRoRt2mIbtk?si=5DgiSMQgSQ5MjBZ5" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>                
    </div>
</section>
