...
<section class="bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6 grid grid-cols-3 place-items-center">
        ...
        <div class="flex flex-col px-5 pb-5">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="detailmobil.php" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Lihat detail</a>
            </div>
        </div>
    </div>
  ...
  <div class="w-full max-w-sm rounded-lg shadow bg-gray-800 border-gray-200 h-full">
        ...
        <div class="flex flex-col px-5 pb-5">
            ...
            <div class="flex items-center justify-between">
                <span class="text-xl font-bold text-white-900 dark:text-white">Rp 3,41 M</span>
                <a href="detailmobil.php" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Lihat detail</a>
            </div>
        </div>
    </div>
  ...
  <div class="w-full max-w-sm rounded-lg shadow bg-gray-800 border-gray-200 h-full">
        ...
        <div class="flex flex-col px-5 pb-5">
            ...
            <div class="flex items-center justify-between">
                <span class="text-xl font-bold text-white-900 dark:text-white">Rp 3,59 M</span>
                <a href="detailmobil.php"  class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Lihat detail</a>
            </div>
        </div>
    </div>
