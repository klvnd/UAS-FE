      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div class="hidden sm:ml-6 sm:block">
          <div class="flex space-x-4">
            ...
            <a href="#" class="rounded-md px-3 py-2 text-white text-sm font-medium hover:text-amber-500 z-50" aria-current="page">Beranda</a>
            <a href="#" class=" hover:text-amber-500 z-50 text-white  rounded-md px-3 py-2 text-sm font-medium">Tentang</a>
